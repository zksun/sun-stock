 ...
 */
public class IOGetBytesTestHandler implements IOHandler<Void, byte[]> {
...
//			}
			...
			if (null == excludeRightses) {
				excludeRightses = SohuInfoExplorer.getInstance().
						getExcludeRightsInfo(stockCode, com.sun.stock.domain.enums.Timer.DAY);
				if (null == excludeRightses) {
					excludeRightses = Collections.EMPTY_LIST;
				}
			}

			Long adjustPrice = null;
			try {
