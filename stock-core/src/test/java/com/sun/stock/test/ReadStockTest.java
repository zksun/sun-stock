...
import com.sun.stock.domain.Stock;
...
public class ReadStockTest {
	...
	public void testGetStockDataFile() {
		try {
			File stockDataFile = StockUtil.getStockDataFile(StockType.SHANGHAI, "601186", "20140102");
	...
	public void testDealStockDataFileLine() {
		try {
			File stockDataFile = StockUtil.getStockDataFile(StockType.SHANGHAI, "601186", "20160102");
	...
	public void testDealStockDataFileBytes() {
		try {
			File stockDataFile = StockUtil.getStockDataFile(StockType.SHENZHEN, "002024", "20151231");
	...
	public void testDealHuShen300LotsStockDataFileBytes() {
		List<String> allStockDirectoryNames = StockUtil.getAllStockDirectoryNames();
