package com.sun.stock.util;

import com.sun.org.apache.bcel.internal.classfile.Code;
import com.sun.stock.common.internal.IOUtil;
import com.sun.stock.common.internal.StringUtil;
import com.sun.stock.domain.enums.StockType;
import com.sun.stock.system.Environment;
...
public final class StockUtil {
	...
	public static List<String> getAllStockDirectoryNames() {
	...
	public static File getStockDataFile(StockType type, String stockCode, Date date) {
		if (StringUtil.isBlank(stockCode) || null == type || null == date) {
			throw new NullPointerException();
		}
	...
	public static File getStockDataFile(StockType type, String stockCode, String date) throws ParseException {
		if (StringUtil.isBlank(stockCode) || StringUtil.isBlank(date)) {
			throw new NullPointerException();
		}

		DateFormat dateFormat = new SimpleDateFormat(COMMON_DATE_FORMATTER);
		Date parse = dateFormat.parse(date);
		return getStockDataFile(type, stockCode, parse);
	}
